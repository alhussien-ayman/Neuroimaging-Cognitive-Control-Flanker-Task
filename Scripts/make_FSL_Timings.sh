...
for subj in `cat subjList.txt` ; do
        ...
        # NOTE: This script only extracts the trials in which the subject made a correct response. Accuracy is nearly 100% for all subjects, 
        # but as an exercise the student can modify this to extract the incorrect trials as well.
